...
public class NodeCameraViewManager extends ViewGroupManager<RCTNodeCameraView> {
    ...
    private static final int COMMAND_CAPTUREPICTURE_ID = 6;
    private static final String COMMAND_CAPTUREPICTURE = "capturePicture";
    ...
    public Map getExportedCustomBubblingEventTypeConstants() {
        return MapBuilder.builder()
                ...
                .put("onCapturePicture", MapBuilder.of("phasedRegistrationNames", MapBuilder.of("bubbled", "onCapturePicture")))
                .build();
    }
    ...
    public Map<String, Integer> getCommandsMap() {
        return MapBuilder.of(COMMAND_STARTPREV_NAME, COMMAND_STARTPREV_ID, COMMAND_STOPPREV_NAME, COMMAND_STOPPREV_ID,
                ...
                COMMAND_SWITCH_CAM_ID, COMMAND_SWITCH_FLASH_NAME, COMMAND_SWITCH_FLASH_ID, COMMAND_CAPTUREPICTURE, COMMAND_CAPTUREPICTURE_ID);
    }
    ...
    public void receiveCommand(RCTNodeCameraView root, int commandId, @Nullable ReadableArray args) {
        switch (commandId) {
            ...
            case COMMAND_SWITCH_FLASH_ID:
                ...
                break;
            case COMMAND_CAPTUREPICTURE_ID:
                root.capturePicture();
                break;
        }
    }
